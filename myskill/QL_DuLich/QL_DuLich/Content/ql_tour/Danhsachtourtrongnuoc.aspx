<%@ Page Title="" Language="C#" MasterPageFile="~/Content/ql_tour/Trangchu.master" AutoEventWireup="true" CodeFile="Danhsachtourtrongnuoc.aspx.cs" Inherits="Content_ql_tour_Danhsachtourtrongnuoc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QL_DuLichConnectionString %>" SelectCommand="SELECT Tour.TenTour, Tour.LoaiTour, Tour.SoNgay, Tour.GiaTour, ChiTiet.Hinh, Tour.MaTour, ChiTiet.NgayKhoiHanh FROM ChiTiet INNER JOIN Tour ON ChiTiet.MaTour = Tour.MaTour WHERE (Tour.LoaiTour = @LoaiTour)">
        <SelectParameters>
            <asp:Parameter DefaultValue="Trong nước" Name="LoaiTour" />
        </SelectParameters>
    </asp:SqlDataSource>
           ...
           <ItemTemplate>
               <table style="width:100%;">
                   ...
                   <tr>
                       <td>&nbsp;</td>
                       <td>
                           <asp:ImageButton ID="ImageButton5" runat="server" Height="30px" CommandName="xemchitiet" CommandArgument='<%# Eval("MaTour") %>' ImageUrl="~/Content/Images/view.png" style="margin-left: 46px" OnClick="ImageButton5_Click" />
                       </td>
                   </tr>
               </table>
               <br />
