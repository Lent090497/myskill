<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="DanhSachTourTrongNuoc.aspx.cs" Inherits="Content_DanhSachTourTrongNuoc" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">


    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:QL_DuLichConnectionString %>" SelectCommand="SELECT * FROM [Tour] WHERE ([LoaiTour] = @LoaiTour)">
        <SelectParameters>
            <asp:Parameter DefaultValue="Trong nước" Name="LoaiTour" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
     ...
     <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" KeyFieldName="MaTour" Width="100%">
         <Columns>
             ...
             <dx:GridViewDataTextColumn Caption="Giá " FieldName="GiaTour" VisibleIndex="4">
             </dx:GridViewDataTextColumn>
